...
Feature: My loan details and borrower details verification.
  ...
  @Demo1
  Scenario: As a user I Login to celink and verify common question page title
  ...
  @Demo1
  Scenario: As a user I Login to celink and navigated to View Loan Details and verified Current Net Principal Limit text
  ...
  #TestcasName     : Demo Test Case -4
  @Demo
  Scenario: As a user I Login to celink and navigated to borrower details and verified name
